...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = kScreenWidth * 0.672
    public static var leftBezelWidth: CGFloat? = 16.0
    public static var contentViewScale: CGFloat = 1.0 // change  0.96
    public static var contentViewOpacity: CGFloat = 0.50
    ...
    public static var animationOptions: UIView.AnimationOptions = [.transitionFlipFromLeft]
    ...
    public static var opacityViewBackgroundColor: UIColor = UIColor.colorFromHexWithAlpha(hex: 0x000000, opacity: 0.70)
...
open class SlideMenuController: UIViewController , UIGestureRecognizerDelegate {
    ...
    open func initView() {
        mainContainerView = UIView(frame: CGRect(x: 0, y: 0, width: kScreenWidth, height: kScreenHeight))
    ...
    open func openRightWithVelocity(_ velocity: CGFloat) {
        ...
        var duration: TimeInterval = Double(SlideMenuOptions.animationDuration)
        if velocity != 0.0 {
            duration = Double(abs(xOrigin - view.bounds.width) / velocity) //fabs
            duration = Double(fmax(0.1, fmin(1.0, duration)))
        }
