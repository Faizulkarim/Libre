...
extension FormatStyle where Self: NSObject {
    ...
    @discardableResult func fontSize(size: CGFloat) -> Self {
        ...
        case is UILabel:
            ...
            if let font = CustomFont(rawValue: lbl.font.familyName) {
        ...
        case is UIButton:
            ...
            if let font = CustomFont(rawValue: btn.titleLabel?.font.familyName ?? "") {
        ...
        case is UITextField:
            ...
            if let font = CustomFont(rawValue: txtField.font?.familyName ?? "") {
        ...
        case is UITextView:
            ...
            if let font = CustomFont(rawValue: txtv.font?.familyName ?? "") {
